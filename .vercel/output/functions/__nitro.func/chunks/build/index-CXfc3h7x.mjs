import { mergeProps, defineComponent, unref, withCtx, createTextVNode, isRef, createVNode, toDisplayString, ref, reactive, computed, toValue, watch, provide, readonly, toRef, resolveDynamicComponent, h, renderSlot, watchEffect, nextTick, shallowRef, getCurrentInstance, inject, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from 'vue/server-renderer';
import { reactiveOmit } from '@vueuse/core';
import { Label } from 'reka-ui';
import { _ as _sfc_main$1$1, a as _sfc_main$2, c as cn } from './index-BCVr8lgN.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "border-2 border-white h-[400px] w-[300px] p-5 rounded-2xl" }, _attrs))}><p class="text-center text-2xl">Login</p>`);
      _push(ssrRenderComponent(_component_Form, {
        onSubmit: unref(onSubmit),
        class: "mt-[30px] grid grid-cols-1 gap-10"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Label, { for: "terms" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Username or email`);
                } else {
                  return [
                    createTextVNode("Username or email")
                  ];
                }
              }),
              _: 1
            ...
            _push2(`<span class="text-red-500"${_scopeId}>${ssrInterpolate(unref(errors).email)}</span></div><div${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Label, { for: "terms" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Password`);
            ...
            _push2(`<span class="text-red-500"${_scopeId}>${ssrInterpolate(unref(errors).password)}</span></div>`);
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("span", { class: "text-red-500" }, toDisplayString(unref(errors).email), 1)
              ]),
              createVNode("div", null, [
                createVNode(_component_Label, { for: "terms" }, {
                  default: withCtx(() => [
                ...
                createVNode("span", { class: "text-red-500" }, toDisplayString(unref(errors).password), 1)
              ]),
...
//# sourceMappingURL=index-CXfc3h7x.mjs.map
